...
import flame from '@/../public/components/mint/flameFac.svg';
import twilight from '@/../public/components/mint/twilightFac.svg';
import arcane from '@/../public/components/mint/arcaneFac.svg';
import light from '@/../public/components/mint/lightFac.svg';
...
export function SelectFaction() {
  ...
  const handleSelectFac = (herofaction: string) => {
